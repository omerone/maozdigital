          ...
          <div className="bg-white p-8 rounded-xl border border-gray-200">
            ...
            >
              ...
              <button
                ...
                className="w-full bg-[#D1A055] hover:bg-[#bf9144] text-white font-semibold py-4 px-8 rounded-full transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isSubmitting 
                  ? 'שולח...' 
                  : isBusinessHoursNow 
